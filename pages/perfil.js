...
const perfil = (props) => {
    ...
    const preguntasJson = {
        ...
        description: 'Proporcione la siguiente información de contacto',
        completedHtml: '<h3>Gracias</h3><h5>Su información ha sido actualizada</h5>',
        progressBarType: 'buttons',
        pages: [
            {
                name: 'Datos del Padre',
                title: 'Datos del Padre',
                description: 'Datos personales del padre del estudiante',
                ...
                elements: [
                    {
                        ...
                        elements: [
                            ...
                            },
                            {
                                startWithNewLine: false,
                                isRequired: true,
                                name: 'estado_civil_padre',
                                title: 'Estado Civíl',
                                type: 'dropdown',
                                colCount: 0,
                                hasNone: false,
                                choices: ['Casado', 'Soltero', 'Divorciado', 'Unión Libre', 'Viudo'],
                            },
                        ],
                    },
                    {
                    ...
                    },
                    {
                        ...
                        elements: [
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_municipio_padre',
                                title: 'Municipio',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otro',
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_localidad_padre',
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_codigopostal_padre',
                                title: 'Código Postal',
                                type: 'text',
                            },
                            {
                                startWithNewLine: false,
                                name: 'domicilio_colonia_padre',
                                title: 'Colonia',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otra',
                            ...
                            {
                                startWithNewLine: true,
                                name: 'domicilio_calle_numero_padre',
            ...
            {
                name: 'Datos de la Madre',
                title: 'Datos de la Madre',
                description: 'Datos personales de la madre del estudiante',
                showQuestionNumbers: 'off',
                // Con progressBarType: button:
                navigationTitle: 'Madre',
                navigationDescription: 'Datos Personales',
                elements: [
                    {
                        type: 'boolean',
                        labelTrue: 'Si', // No esta documentado, esta valueTrue
                        labelFalse: 'No', // No esta documentado, esta valueFalse
                        name: 'madre_vive_con_padre',
                        label: '¿El padre y la madre viven en el mismo domicilio?',
                        isRequired: true,
                    },
                    {
                        type: 'panel',
                        ...
                        elements: [
                            ...
                            },
                            {
                                startWithNewLine: false,
                                isRequired: true,
                                name: 'estado_civil_madre',
                                title: 'Estado Civíl',
                                type: 'dropdown',
                                colCount: 0,
                                hasNone: false,
                                choices: ['Casada', 'Soltera', 'Divorciada', 'Unión Libre', 'Viuda'],
                            },
                        ],
                    },
                    {
                        ...
                        elements: [
                            {
                                ...
                                inputFormat: '+#(###)-###-####',
                                inputType: 'phone',
                                visibleIf: '{madre_vive_con_padre} == false',
                            },
                            {
                                startWithNewLine: false,
                                name: 'tel_oficina_madre',
                                title: 'Teléfono de oficina',
                                type: 'text',
                                inputFormat: '+#(###)-###-####',
                                inputType: 'tel',
                    ...
                    },
                    {
                        ...
                        elements: [
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_municipio_madre',
                                title: 'Municipio',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otro',
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_localidad_madre',
                                title: 'Localidad/Ciudad',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otra',
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_codigopostal_madre',
                                title: 'Código Postal',
                                type: 'text',
                            },
                            {
                                startWithNewLine: false,
                                name: 'domicilio_colonia_madre',
                                title: 'Colonia',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otra',
                            ...
                            {
                                startWithNewLine: true,
                                name: 'domicilio_calle_numero_madre',
                                title: 'Calle y número',
                                type: 'text',
                            },
                        ],
            ...
            {
                name: 'Datos del Tutor',
                title: 'Datos del tutor ó contacto de emergencias',
                description: 'Datos personales del tutor del estudiante ó contacto de emergencias',
                showQuestionNumbers: 'off',
                // Con progressBarType: button:
                navigationTitle: 'Tutor/Contacto',
                navigationDescription: 'Datos Personales',
                elements: [
                    {
                        type: 'panel',
                    ...
                    },
                    {
                        ...
                        elements: [
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_municipio_tutor',
                                title: 'Municipio:',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otro',
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_localidad_tutor',
                                title: 'Localidad/Ciudad',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otro',
                            ...
                            {
                                startWithNewLine: false,
                                name: 'domicilio_codigopostal_tutor',
                                title: 'Código Postal:',
                                type: 'text',
                            },
                            {
                                startWithNewLine: false,
                                name: 'domicilio_colonia_tutor',
                                title: 'Colonia',
                                type: 'dropdown',
                                hasOther: true,
                                otherText: 'Otro',
                            ...
                            {
                                startWithNewLine: true,
                                name: 'domicilio_calle_numero_tutor',
                                title: 'Calle y número',
                                type: 'text',
                            },
                        ],
        ...
        <Container maxWidth='md'>
            <Box sx={{ my: 2 }}>
                <Typography variant='body1' component='p' gutterBottom>
                    Su perfil de usuario contiene la información necesaria para el proceso de inscricpión. Ésta información se compone
