...
const getMunicipios = (estado) => {
    const sources = [
        ...
        { estado: 'Baja California', mun: ['Ensenada', 'Mexicali', 'Tecate', 'Tijuana', 'Playas de Rosarito'] },
        { estado: 'Baja California Sur', mun: ['Comondú', 'Mulegé', 'La Paz', 'Los Cabos', 'Loreto'] },
        {
            estado: 'Campeche',
            mun: [
                'Calkiní',
